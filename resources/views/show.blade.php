...
@section('content')
    ...
    <div class="bg-white p-8 rounded-lg shadow-md max-w-2xl mx-auto">
        <h2 class="text-2xl font-bold mb-6 text-gray-800">Edit Student Information</h2>
        ...
        <form action="{{ route('student.update', $student->id) }}" method="POST">
            @csrf
            @method('PUT') {{-- Penting: Memberitahu Laravel bahwa ini adalah request PUT --}}
            ...
            <div class="mb-4">
                ...
                <input 
                    ...
                    name="department" 
                    id="department" 
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('department') border-red-500 @enderror" 
            ...
            <div class="mb-4">
                ...
                <input 
                    ...
                    id="enrollment_year" 
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('enrollment_year') border-red-500 @enderror" 
